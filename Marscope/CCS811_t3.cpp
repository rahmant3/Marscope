// Software from: https://github.com/adafruit/Adafruit_CCS811
// With slight alterations for use with the Teensy 3.6.

#include "CCS811_t3.h"

#define Wire Wire2 // Using Pins 3, 4 for I2C, so make sure to use Wire2 instead of Wire.
...
{
  //Wire.begin();
  Wire.begin(I2C_MASTER, 0x00, I2C_PINS_3_4, I2C_PULLUP_EXT, 400000); // Use for teensy 3.6
